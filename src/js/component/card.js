    ...
    return (
        <div className="card">
            ...
            <div>
                ...
                <p className="card-text text-start ps-3">{props.char_1}: {props.gender}</p>
                <p className="card-text text-start ps-3">{props.char_2}: {props.hair}</p>
                <p className="card-text text-start ps-3">{props.char_3}: {props.eyes}</p>
